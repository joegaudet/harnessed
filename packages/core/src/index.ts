...
export { applyConfig, configure, defineConfig, getConfig, resetConfig, timeoutFor } from './config'
...
export type { Listable } from './list'
...
export type { Navigation, QueryFactory } from './registry'
export {
  describeScope,
  describeSelector,
  label,
